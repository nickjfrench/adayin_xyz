        ...
        defineArrayMember({
          ...
          fields: [
            defineField({
              ...
              type: 'number',
              description:
                "Money value (in this currency's own units) at the top of this price band, e.g. 50, 100. Spend at or below this value falls in this band; the next band above is automatic.",
